...
```
src/
  data/       內容＝唯一事實來源：kana(142)・vocab(~300 N5)・sentences・pairs・pitch・passages・kaiwa(即時応答/発話表現)・dialogues(情境會話)
...
測試：`npm test` 147/147（對真原始碼）、`npm run test:e2e` 43/43（Playwright 瀏覽器點按，
