...
最後更新：v3.43（單字帳：查得到、看得到進度——這一版刻意是**收斂／整合**而非加功能。
...
- **測試**：`npm test` 597/597、`npm run test:e2e` 83/83、`sidecar/test_score.py` 4/4、`test_article.py` 13/13、`npm run build` strict 綠燈。
